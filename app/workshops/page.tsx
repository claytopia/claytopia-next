            ...
            <div className="lg:w-3/5 p-8 lg:p-12 space-y-6">
              ...
              <WorkshopDescription
                ...
                details={
                  <>
                    <p>
                      Du kannst heute kleine Helfer für Küche und Alltag herstellen und sie ganz nach deinen Vorstellungen formen und gestalten. Das kann zum Beispiel eine Schmuckablage sein, eine Ingwer-/Knoblauchreibe, eine Löffelablage oder auch ein Seifenschälchen. Ob schlicht, organisch oder mit individueller Oberfläche – dir stehen verschiedene Möglichkeiten zur Strukturierung zur Verfügung. Auch Farbe kannst du direkt in dein Design integrieren.
                    </p>
                    <p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <p className="text-lg text-foreground-muted">
                Individuelle Workshops sind für Gruppen von 3 bis 10 Personen buchbar. Der Preis richtet sich nach dem zeitlichen Umfang, der Teilnehmerzahl und dem gewünschten Aufwand.
              </p>
              ...
              <div className="bg-stone-50 p-6 rounded-sm border-l-4 border-primary/20 mt-8">
                ...
                <div className="space-y-4 text-sm text-foreground-muted">
                   <p>
                     <strong>Grundpreis:</strong> 220,- € (3 Personen) <br/>
